...
namespace UDP_Server
{
    public class UDP_Server
    {
        static void Main(string[] args)
        {
            ...
            {
                listener.ReceiveTimeout = 5000; //1 секунда таймаут на получение
                ...
                var result = listener.ReceiveFrom(buffer, ref remoteIp);
                ...
                listener.SendTo(Encoding.ASCII.GetBytes("ACK"), remoteIp);
                Console.WriteLine($"Sent message ACK to {remoteIp}");
